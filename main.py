...
def get_text(i, j, gb, l1, l2):
    ...
    if winner(board, "X"):
        gb.destroy()
        box = messagebox.showinfo("Победил", "Игрок 1")
    elif winner(board, "O"):
        gb.destroy()
        box = messagebox.showinfo("Победил", "Игрок 2")
    elif (isfull()):
        gb.destroy()
...
def get_text_pc(i, j, gb, l1, l2):
    ...
    if winner(board, "X"):
        gb.destroy()
        x = False
        box = messagebox.showinfo("Победил", "Игрок")
    elif winner(board, "O"):
        gb.destroy()
        x = False
        box = messagebox.showinfo("Победил", "Компьютер")
    elif (isfull()):
        gb.destroy()
        x = False
        box = messagebox.showinfo("Ничья", "Ничья")
...
def play():
    ...
    head = Button(menu, text="Привет это игра крестики-нолики",
                  activeforeground='red',
                  activebackground="yellow", bg="red",
                  fg="yellow", width=500, font='summer', bd=5)

    B1 = Button(menu, text="1 игрок", command=wpc,
                activeforeground='red',
                activebackground="yellow", bg="red",
                fg="yellow", width=500, font='summer', bd=5)

    B2 = Button(menu, text="2 игрока", command=wpl, activeforeground='red',
